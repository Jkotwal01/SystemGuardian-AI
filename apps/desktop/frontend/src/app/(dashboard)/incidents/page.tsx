export default function IncidentsPage() {
  return (
    <div className="p-6 flex flex-col gap-6 h-full items-center justify-center animate-fade-in text-center">
      ...
      <h2 className="text-xl font-semibold text-[var(--color-text-primary)]">Incident Center</h2>
      <p className="text-[var(--color-text-secondary)] max-w-md">
        Correlated security and performance incidents. Coming in a future phase.
      </p>
    </div>
  );
}
